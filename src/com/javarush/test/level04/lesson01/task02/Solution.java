...
public class Solution
{
    ...
    public static class Apple{
        ...
        public static void addPrice(int applesPrice)
        {
            ...
            Apple.applesPrice = Apple.applesPrice + applesPrice; // Этот правильнее.
                                                              // Apple.applesPrice Это сеттер и геттер статической переменной
            // System.out.println(Apple.applesPrice);          //Потому, что applesPrice - static
          //  System.out.println(applesPrice);
        }

       /* public static void addPrice(int i)
        {
            applesPrice = applesPrice+i;
