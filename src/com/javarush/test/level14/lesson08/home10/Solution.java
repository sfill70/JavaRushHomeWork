...
public class Solution
{
    ...
    public static class NotIncapsulatedClass
    {
        ...
        private void processCastedObjects(List<Number> list)
        {
            for (Number object : list)
            {
                //Исправь 2 ошибки ВРОДЕ ИСПРЕВИЛ
                if (object instanceof Float)
                {
                    Float a = (Float) object;
                    System.out.println("Is float value defined? " + a.isNaN());
                   // System.out.println(a + a.getClass().getSimpleName() + "  dol");
                } else if    (object instanceof Double)
                {
                    Double a = (Double) object;
                    System.out.println("Is double value infinite? " + a.isInfinite());
                 //   System.out.println(object + a.getClass().getSimpleName() + "   Flo");
                }
            }
