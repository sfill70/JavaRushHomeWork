...
public class Solution {
    ...
    public static class A {
        ...
        private void initialize() {
            System.out.println(f1+A.class.getSimpleName()+B.class.getDeclaredFields());
        }
    }
    ...
    public static class B extends A {
        ...
        protected void initialize() {
            System.out.println(f1+A.class.getSimpleName()+B.class.hashCode());
        }
    }
